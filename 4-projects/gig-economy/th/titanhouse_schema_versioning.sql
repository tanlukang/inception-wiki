...
-- ----------------------------
-- Table structure for Experiences_Industries__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Experiences_Industries__Versions";
CREATE TABLE "titanhouse_schema"."Experiences_Industries__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
...
;
ALTER TABLE "titanhouse_schema"."Experiences_Industries__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Jobs_CompanyIndustries__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Jobs_CompanyIndustries__Versions";
CREATE TABLE "titanhouse_schema"."Jobs_CompanyIndustries__Versions" (
...
;
ALTER TABLE "titanhouse_schema"."Jobs_CompanyIndustries__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Jobs_CompanyMiniTags__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Jobs_CompanyMiniTags__Versions";
CREATE TABLE "titanhouse_schema"."Jobs_CompanyMiniTags__Versions" (
  "jobVersionId" int4 NOT NULL,
  "miniTagId" int4 NOT NULL,
  "createdAt" timestamptz(6) NOT NULL,
  "updatedAt" timestamptz(6) NOT NULL
...
;
ALTER TABLE "titanhouse_schema"."Jobs_CompanyMiniTags__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Jobs_PositionDepartments__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Jobs_PositionDepartments__Versions";
CREATE TABLE "titanhouse_schema"."Jobs_PositionDepartments__Versions" (
  "jobVersionId" int4 NOT NULL,
  "departmentId" int4 NOT NULL,
  "createdAt" timestamptz(6) NOT NULL,
  "updatedAt" timestamptz(6) NOT NULL
...
;
ALTER TABLE "titanhouse_schema"."Jobs_PositionDepartments__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Organizations_Industries__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Organizations_Industries__Versions";
CREATE TABLE "titanhouse_schema"."Organizations_Industries__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
...
;
ALTER TABLE "titanhouse_schema"."Organizations_Industries__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Organizations_MiniTags__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Organizations_MiniTags__Versions";
CREATE TABLE "titanhouse_schema"."Organizations_MiniTags__Versions" (
  "miniTagId" int4 NOT NULL,
  "createdAt" timestamptz(6) NOT NULL,
  "updatedAt" timestamptz(6) NOT NULL,
  "organizationVersionId" int4 NOT NULL
...
;
ALTER TABLE "titanhouse_schema"."Organizations_MiniTags__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Talents_Experiences__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Talents_Experiences__Versions";
CREATE TABLE "titanhouse_schema"."Talents_Experiences__Versions" (
...
;
ALTER TABLE "titanhouse_schema"."Talents_Experiences__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Talents_InterestIndustries__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Talents_InterestIndustries__Versions";
CREATE TABLE "titanhouse_schema"."Talents_InterestIndustries__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
  "talentVersionId" int4 NOT NULL,
  "industryId" int4 NOT NULL
...
;
ALTER TABLE "titanhouse_schema"."Talents_InterestIndustries__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Talents_InterestRoles__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Talents_InterestRoles__Versions";
CREATE TABLE "titanhouse_schema"."Talents_InterestRoles__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
  "roleId" int4 NOT NULL,
  "talentVersionId" int4 NOT NULL
...
;
ALTER TABLE "titanhouse_schema"."Talents_InterestRoles__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Talents_WorkIndustries__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Talents_WorkIndustries__Versions";
CREATE TABLE "titanhouse_schema"."Talents_WorkIndustries__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
  "talentVersionId" int4 NOT NULL,
  "industryId" int4 NOT NULL,
...
;
ALTER TABLE "titanhouse_schema"."Talents_WorkIndustries__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Table structure for Talents_WorkRoles__Versions
-- ----------------------------
DROP TABLE IF EXISTS "titanhouse_schema"."Talents_WorkRoles__Versions";
CREATE TABLE "titanhouse_schema"."Talents_WorkRoles__Versions" (
  "createdAt" timestamptz(6) NOT NULL DEFAULT now(),
  "updatedAt" timestamptz(6) NOT NULL DEFAULT now(),
  "talentVersionId" int4 NOT NULL,
  "roleId" int4 NOT NULL,
...
;
ALTER TABLE "titanhouse_schema"."Talents_WorkRoles__Versions" OWNER TO "postgres";
...
-- ----------------------------
-- Primary Key structure for table Experiences_Industries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Experiences_Industries__Versions" ADD CONSTRAINT "Experiences_Industries_copy1_pkey" PRIMARY KEY ("experienceVersionId", "industryId");
...
-- ----------------------------
-- Primary Key structure for table Jobs_CompanyIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_CompanyIndustries__Versions" ADD CONSTRAINT "Jobs_CompanyIndustries_copy1_pkey" PRIMARY KEY ("jobVersionId", "industryId");
...
-- ----------------------------
-- Primary Key structure for table Jobs_CompanyMiniTags__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_CompanyMiniTags__Versions" ADD CONSTRAINT "Jobs_CompanyMiniTags_copy1_pkey" PRIMARY KEY ("jobVersionId", "miniTagId");
...
-- ----------------------------
-- Primary Key structure for table Jobs_PositionDepartments__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_PositionDepartments__Versions" ADD CONSTRAINT "Jobs_PositionDepartments_copy1_pkey" PRIMARY KEY ("jobVersionId", "departmentId");
...
-- ----------------------------
-- Primary Key structure for table Organizations_Industries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations_Industries__Versions" ADD CONSTRAINT "Organizations_Industries_copy1_pkey" PRIMARY KEY ("organizationVersionId", "industryId");
...
-- ----------------------------
-- Primary Key structure for table Organizations_MiniTags__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations_MiniTags__Versions" ADD CONSTRAINT "Organizations_MiniTags_copy1_pkey" PRIMARY KEY ("miniTagId", "organizationVersionId");
...
-- ----------------------------
-- Primary Key structure for table Talents_Experiences__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_Experiences__Versions" ADD CONSTRAINT "Talents_Experiences__Versions_pkey" PRIMARY KEY ("talentVersionId", "experienceVersionId");
...
-- ----------------------------
-- Primary Key structure for table Talents_InterestIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_InterestIndustries__Versions" ADD CONSTRAINT "Talents_Interest_Industries_copy1_pkey" PRIMARY KEY ("talentVersionId", "industryId");
...
-- ----------------------------
-- Primary Key structure for table Talents_InterestRoles__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_InterestRoles__Versions" ADD CONSTRAINT "Talents_Interest_Roles_copy1_pkey" PRIMARY KEY ("roleId", "talentVersionId");
...
-- ----------------------------
-- Primary Key structure for table Talents_WorkIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_WorkIndustries__Versions" ADD CONSTRAINT "Talents_Work_Industries_copy1_pkey" PRIMARY KEY ("talentVersionId", "industryId");
...
-- ----------------------------
-- Primary Key structure for table Talents_WorkRoles__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_WorkRoles__Versions" ADD CONSTRAINT "Talents_Work_Roles_copy1_pkey" PRIMARY KEY ("talentVersionId", "roleId");
...
ALTER TABLE "titanhouse_schema"."Experiences" ADD CONSTRAINT "Experiences_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "titanhouse_schema"."Experiences__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Experiences_Industries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Experiences_Industries__Versions" ADD CONSTRAINT "Experiences_Industries__Versions_experienceVersionId_fkey" FOREIGN KEY ("experienceVersionId") REFERENCES "titanhouse_schema"."Experiences__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Experiences_Industries__Versions" ADD CONSTRAINT "Experiences_Industries__Versions_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "titanhouse_schema"."Industries" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table Experiences__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Experiences__Versions" ADD CONSTRAINT "Experiences__Versions_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "titanhouse_schema"."Experiences" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "titanhouse_schema"."Experiences__Versions" ADD CONSTRAINT "Experiences__Versions_previousVersionId_fkey" FOREIGN KEY ("previousVersionId") REFERENCES "titanhouse_schema"."Experiences__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "titanhouse_schema"."Jobs" ADD CONSTRAINT "Jobs_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "titanhouse_schema"."Jobs__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Jobs_CompanyIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_CompanyIndustries__Versions" ADD CONSTRAINT "Jobs_CompanyIndustries__Versions_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "titanhouse_schema"."Industries" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Jobs_CompanyIndustries__Versions" ADD CONSTRAINT "Jobs_CompanyIndustries__Versions_jobVersionId_fkey" FOREIGN KEY ("jobVersionId") REFERENCES "titanhouse_schema"."Jobs__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Jobs_CompanyMiniTags__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_CompanyMiniTags__Versions" ADD CONSTRAINT "Jobs_CompanyMiniTags__Versions_jobVersionId_fkey" FOREIGN KEY ("jobVersionId") REFERENCES "titanhouse_schema"."Jobs__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Jobs_CompanyMiniTags__Versions" ADD CONSTRAINT "Jobs_CompanyMiniTags__Versions_miniTagId_fkey" FOREIGN KEY ("miniTagId") REFERENCES "titanhouse_schema"."MiniTags" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Jobs_PositionDepartments__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Jobs_PositionDepartments__Versions" ADD CONSTRAINT "Jobs_PositionDepartments__Versions_departmentId_fkey" FOREIGN KEY ("departmentId") REFERENCES "titanhouse_schema"."Departments" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Jobs_PositionDepartments__Versions" ADD CONSTRAINT "Jobs_PositionDepartments__Versions_jobVersionId_fkey" FOREIGN KEY ("jobVersionId") REFERENCES "titanhouse_schema"."Jobs__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE "titanhouse_schema"."Jobs__Versions" ADD CONSTRAINT "Jobs__Versions_previousVersionId_fkey" FOREIGN KEY ("previousVersionId") REFERENCES "titanhouse_schema"."Jobs__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table Organizations
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations" ADD CONSTRAINT "Organizations_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "titanhouse_schema"."Organizations__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Organizations_Industries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations_Industries__Versions" ADD CONSTRAINT "Organizations_Industries__Versions_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "titanhouse_schema"."Industries" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Organizations_Industries__Versions" ADD CONSTRAINT "Organizations_Industries__Versions_organizationVerionId_fkey" FOREIGN KEY ("organizationVersionId") REFERENCES "titanhouse_schema"."Organizations__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Organizations_MiniTags__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations_MiniTags__Versions" ADD CONSTRAINT "Organizations_MiniTags__Versions_miniTagId_fkey" FOREIGN KEY ("miniTagId") REFERENCES "titanhouse_schema"."MiniTags" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Organizations_MiniTags__Versions" ADD CONSTRAINT "Organizations_MiniTags__Versions_organizationVersionId_fkey" FOREIGN KEY ("organizationVersionId") REFERENCES "titanhouse_schema"."Organizations__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table Organizations__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Organizations__Versions" ADD CONSTRAINT "Organizations__Versions_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "titanhouse_schema"."Organizations" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Organizations__Versions" ADD CONSTRAINT "Organizations__Versions_previousVersionId_fkey" FOREIGN KEY ("previousVersionId") REFERENCES "titanhouse_schema"."Organizations__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents" ADD CONSTRAINT "Talents_versionId_fkey" FOREIGN KEY ("versionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table Talents_Experiences__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_Experiences__Versions" ADD CONSTRAINT "Talents_Experiences__Versions_experienceVersionId_fkey" FOREIGN KEY ("experienceVersionId") REFERENCES "titanhouse_schema"."Experiences__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents_Experiences__Versions" ADD CONSTRAINT "Talents_Experiences__Versions_talentVersionId_fkey" FOREIGN KEY ("talentVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Talents_InterestIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_InterestIndustries__Versions" ADD CONSTRAINT "Talents_InterestIndustries__Versions_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "titanhouse_schema"."Industries" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents_InterestIndustries__Versions" ADD CONSTRAINT "Talents_InterestIndustries__Versions_talentVersionId_fkey" FOREIGN KEY ("talentVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Talents_InterestRoles__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_InterestRoles__Versions" ADD CONSTRAINT "Talents_InterestRoles__Versions_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "titanhouse_schema"."Roles" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents_InterestRoles__Versions" ADD CONSTRAINT "Talents_InterestRoles__Versions_talentVersionId_fkey" FOREIGN KEY ("talentVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Talents_WorkIndustries__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_WorkIndustries__Versions" ADD CONSTRAINT "Talents_WorkIndustries__Versions_industryId_fkey" FOREIGN KEY ("industryId") REFERENCES "titanhouse_schema"."Industries" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents_WorkIndustries__Versions" ADD CONSTRAINT "Talents_WorkIndustries__Versions_talentVersionId_fkey" FOREIGN KEY ("talentVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- ----------------------------
-- Foreign Keys structure for table Talents_WorkRoles__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents_WorkRoles__Versions" ADD CONSTRAINT "Talents_WorkRoles_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "titanhouse_schema"."Roles" ("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents_WorkRoles__Versions" ADD CONSTRAINT "Talents_WorkRoles_talentVersionId_fkey" FOREIGN KEY ("talentVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table Talents__Versions
-- ----------------------------
ALTER TABLE "titanhouse_schema"."Talents__Versions" ADD CONSTRAINT "Talents__Versions_entityId_fkey" FOREIGN KEY ("entityId") REFERENCES "titanhouse_schema"."Talents" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABLE "titanhouse_schema"."Talents__Versions" ADD CONSTRAINT "Talents__Versions_previousVersionId_fkey" FOREIGN KEY ("previousVersionId") REFERENCES "titanhouse_schema"."Talents__Versions" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
